        ...
        <div class="panel panel-primary">
          ...
          <div class="panel-body" style="height: 800px; overflow-y: scroll">
            ...
            <div id="stores">
              ...
              <div><input type="checkbox" /> Alza.co.uk</div>
              <div><input type="checkbox" /> ao.co.uk</div>
              <div><input type="checkbox" /> Appliances Direct</div>
              <div><input type="checkbox" /> Argos</div>
              <div><input type="checkbox" /> Aria PC Technology</div>
              <div><input type="checkbox" /> Asda</div>
              <div><input type="checkbox" /> B&amp;M</div>
              <div><input type="checkbox" /> Boots</div>
              <div><input type="checkbox" /> Brooklyn Trading</div>
              <div><input type="checkbox" /> BT Shop</div>
              <div><input type="checkbox" /> Chain Reaction Cycles</div>
              <div><input type="checkbox" /> Clas Ohlson</div>
              <div><input type="checkbox" /> Co op Electrical</div>
              <div><input type="checkbox" /> Costco</div>
              <div><input type="checkbox" /> CPC</div>
              <div><input type="checkbox" /> Currys PC World</div>
              <div><input type="checkbox" /> Debenhams</div>
              <div><input type="checkbox" /> Decathlon</div>
              <div><input type="checkbox" /> Dunelm</div>
              <div><input type="checkbox" /> Ebuyer</div>
              <div><input type="checkbox" /> GameSeek</div>
              <div><input type="checkbox" /> George</div>
              <div><input type="checkbox" /> H&amp;M</div>
              <div><input type="checkbox" /> Halfords</div>
              <div><input type="checkbox" /> Holland &amp; Barrets</div>
              <div><input type="checkbox" /> Home Bargains</div>
              <div><input type="checkbox" /> Homebase</div>
              <div><input type="checkbox" /> House of Fraser</div>
              <div><input type="checkbox" /> Hughes</div>
              <div><input type="checkbox" /> Iceland</div>
              <div><input type="checkbox" /> IKEA</div>
              <div><input type="checkbox" /> JD Williams</div>
              <div><input type="checkbox" /> Jessops</div>
              <div><input type="checkbox" /> John Lewis</div>
              <div><input type="checkbox" /> Lakeland</div>
              <div><input type="checkbox" /> Littlewoods</div>
              <div><input type="checkbox" /> Machine Mart</div>
              <div><input type="checkbox" /> Maplin</div>
              <div><input type="checkbox" /> M&amp;S</div>
              <div><input type="checkbox" /> Matalan</div>
              <div><input type="checkbox" /> Morrisons</div>
              <div><input type="checkbox" /> My Memory</div>
              <div><input type="checkbox" /> New Look</div>
              <div><input type="checkbox" /> Next</div>
              <div><input type="checkbox" /> Novatech</div>
              <div><input type="checkbox" /> Ocado</div>
              <div><input type="checkbox" /> Pets at Home</div>
              <div><input type="checkbox" /> Robert Dyas</div>
              <div><input type="checkbox" /> Rutland Cycling</div>
              <div><input type="checkbox" /> Ryman</div>
              <div><input type="checkbox" /> Sainsbury&#39;s</div>
              <div><input type="checkbox" /> Scan</div>
              <div><input type="checkbox" /> Screwfix</div>
              <div><input type="checkbox" /> Selfridges</div>
              <div><input type="checkbox" /> Smyths</div>
              <div><input type="checkbox" /> SpaceNK</div>
              <div><input type="checkbox" /> Sports Direct</div>
              <div><input type="checkbox" /> Superdrug</div>
              <div><input type="checkbox" /> Tekheads</div>
              <div><input type="checkbox" /> Tesco</div>
              <div><input type="checkbox" /> Tesco Direct</div>
              <div><input type="checkbox" /> The British Home Store</div>
              <div><input type="checkbox" /> The Hut</div>
              <div><input type="checkbox" /> The Range</div>
              <div><input type="checkbox" /> The Words</div>
              <div><input type="checkbox" /> TK MAX</div>
              <div><input type="checkbox" /> Tool Station</div>
              <div><input type="checkbox" /> Very</div>
              <div><input type="checkbox" /> Waitrose</div>
              <div><input type="checkbox" /> WH Smith</div>
              <div><input type="checkbox" /> Wickes</div>
              <div><input type="checkbox" /> Wiggle</div>
              <div><input type="checkbox" /> Wilko</div>
            </div>
          </div>

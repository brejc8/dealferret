$('document').ready(function()
{
 ...
 //---
 cookie_accept = document.getElementById("cookie-accept");
 if (cookie_accept) cookie_accept.onclick = function(e) {
   days = 182; //number of days to keep the cookie
   myDate = new Date();
   myDate.setTime(myDate.getTime()+(days*24*60*60*1000));
   document.cookie = "comply_cookie = comply_yes; expires = " + myDate.toGMTString(); //creates the cookie: name|value|expiry
  ...
  $("#login-form").validate({
   ...
   login_user_name: {
       ...
       messages:
    {
            ...
            login_user_name: "please enter your username",
       },
...
$('document').ready(function()
{
   ...
   rules:
   {
    ...
    messages:
    {
      reg_user_name: "please enter user name",
      reg_password:{
           required: "please provide a password",
           minlength: "password at least have 6 characters"
           },
      reg_user_email: "please enter a valid email address",
      reg_cpassword:{
        ...
        success : function(data)
              {            
                if(data=="Success")
                {
                    ...
                    $(".register-form").html("<div class='alert alert-success'><strong>Success!</strong> Successfully Registered.</div>");
...
$(document).ready(function(){
    ...
    $(".checkbox-reset").click(function(){
            $('#store input[type=checkbox]').each(function(){this.checked = false;}); 
            $('.checked').toggleClass('checked');
	    return false;
	    });

    $(".deals-show-all").click(function(){
    	    $("input#discount_slider").attr('disabled','disabled');
	    return true;
	    });
	...
	$("#discount_slider").on("slideStop", function(slideEvt) {
		$("#discountsliderValue").text(slideEvt.value[0] + " - " + slideEvt.value[1]);
	...
	formatter: function(value) {
		...
		return value[0] + " - " + m + " days";
		}});
    
	$("#age_slider").on("slideStop", function(slideEvt) {
        m = slideEvt.value[1];
        if (slideEvt.value[1] == 100) m = "\u221E";
		$("#agesliderValue").text(slideEvt.value[0] + " - " + m);
    	document.getElementById("products_form").submit();
	});
...
$( document ).ready(function() {
	$("#tagentry").keyup(function() {
		...
		if (keyword.length >= 2) {
			...
			$.get( "tagsjson.php", { keyword: keyword } )
			.done(function( data ) {
				$('#tagsresults').html('');
